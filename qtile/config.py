...
groups.append(ScratchPad("scratchpad", [
    ...
    DropDown("pulsemixer", "alacritty --class=pulsemixer -e pulsemixer", width=0.8, height=0.8, x=0.1, y=0.1, opacity=0.9),
...
keys.extend([
    ...
    Key([mod, "control"], "v", lazy.group['scratchpad'].dropdown_toggle('pavucontrol')),
...
def init_secondary_widgets_list(monitor_num):
    ...
    del secondary_widgets_list[18:19]
